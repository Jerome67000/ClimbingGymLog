...
public class EditVoieDialog extends DialogFragment {
    ...
    private void updateVoie() {
        ...
        voieEdited = new Voie(voieToEdit.getId(), titre, cotation, typeEsc, styleVoie, reussiToggleButton.isChecked(), aVueToggleButton.isChecked(), note.getText().toString(), voieToEdit.getIdSeance());
